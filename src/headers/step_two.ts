export type UserParams = { firstName: string; lastName: string; email: string; phone: string; };

export const getStepTwoHeaders = (schedulerCookie: string, sessionCookie: string, htmlCode: string, user: UserParams) => ({
